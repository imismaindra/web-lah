...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Klik figcaption untuk edit caption — tanpa contenteditable, biar tidak duplikat/hilang
            ...
            // Inject tombol ke toolbar Quill biar tidak perlu scroll
