...
@section('content')
    <div class="mx-auto max-w-2xl">
        ...
        <div class="rounded-2xl border border-stone-200/60 bg-white p-6 dark:border-white/[0.06] dark:bg-[#171716] sm:p-8">
            <h2 class="font-serif text-xl font-bold tracking-tight">Era Baru</h2>
            <p class="mt-1 text-sm text-stone-500 dark:text-stone-400">Tambahkan era untuk section "Perjalanan Waktu" di beranda</p>

            <form method="POST" action="{{ route('admin.era.store') }}" enctype="multipart/form-data" class="mt-8 space-y-6">
                @csrf
