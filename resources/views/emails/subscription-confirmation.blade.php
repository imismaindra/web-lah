                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#ffffff;border:1px solid #e7e5e4;border-radius:12px;overflow:hidden;">
                        ...
                        <tr>
                            <td style="padding:40px;">
                                <h1 style="margin:0 0 16px;font-size:26px;font-weight:bold;line-height:1.3;color:#1c1917;">Kamu berhasil berlangganan</h1>
                                <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#57534e;">Terima kasih sudah berlangganan <strong>{{ config('app.name', 'Look at History') }}</strong>. Kami akan mengirimkan artikel sejarah dunia terbaru langsung ke inbox kamu.</p>
                                <p style="margin:0;font-size:15px;line-height:1.7;color:#57534e;">Tanpa spam, dan kamu bisa berhenti kapan saja.</p>
                            </td>
                        </tr>
                        <tr>
